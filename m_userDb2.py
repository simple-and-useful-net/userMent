    ...
    def selectUser( self, jsData ):
        ...
        try:
          ...
          if True:
            ...
            sql = "select *  from userInf where name like %s"
            # print("sql=",         sql)
            # print("vals=",         vals)
    ...
    def selectIdUser( self, id ):
        ...
        try:
          ...
          if True:
            ...
            sql = "select *  from userInf where id = %s"
            # print("sql=",         sql)
    ...
    def listLast( self ):
        ...
        try:
          if True:
            ...
            cursor2 = self.con.cursor ( dictionary=True )
            cursor2.execute("select * from userInf where %s order by id desc limit 11" %self.cond )
